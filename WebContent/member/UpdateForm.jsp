...
<body>
	...
	<div class="container-sm">
		...
		<div class="row">
			...
			<div class="col-6">
				<form name="Member" action="UpdatePro.jsp" method="post">
					<div class="row">
						<div class="col-8">
					...
					<div align="center">
						...
						<input type="button" class="btn btn-secondary" onclick="delete()" value="탈퇴하기">
			</div>
			<div class="col-3"></div>
